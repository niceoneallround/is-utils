...

{
   ...
   query_nodes: [
     { @id: blank node id
       ...
       pn_p.pndatamodel: the @id - defines the @type of the output subject graph generated by the SyndEntity, and also used for common identity attributes mapping
       ...
       pn_p.properties: // the requested output graph need to think more how to represent - maybe as a json schema or a properitery
        familyName:
        givenName:
        taxID:
     }
  ...
  */
  ...
  static createPublicJSONCanonById(props) {
    ...
    return {
      ...
      graph: {
        bob: {
          __params: { id: subjectId, }, // query params
